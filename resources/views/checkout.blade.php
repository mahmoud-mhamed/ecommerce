                    ...
                    <div class="checkout-totals-left">
                        ...
                        @if (session()->has('coupon'))
                            ...
                            <form action="{{route('coupon.destroy')}}" method="post" class="d-inline">
                                @csrf
                                @method('delete')
                                <button type="submit" style="font-size: 14px;" class="bg-transparent">Remove</button>
                            </form>
                            <br>
                            <hr>
                            New Subtotal <br>
...
@section('extra-js')
    ...
    <script>
        (function(){
            ...
            var stripe = Stripe('pk_test_623cSVJe1rz6Fi15EXu7v0NO00rxHjIz0f');
            ...
            var client_token = "sk_test_IaEhvIJxkgZqhvgfyVkttYBK00raQZ8GYft";
